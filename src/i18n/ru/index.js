...
const ru = {
  ...
  about: {
    ...
    texts: {
      experienced: {
        title: 'Опыт.',
        text_card:
          'Более десяти лет мы обеспечиваем техническое сопровождение  мероприятий и праздников  предоставляя нашим клиентам профессионализм, опыт и техническое оборудование самого высокого уровня.',
        text: 'NEKO -  индивидуальный подход в области звука, света, видео, презентационных технологий и строительства сцен. Мы предлагаем широкий спектр оборудования и услуг для мероприятий любых размеров.',
  ...
  services: {
    ...
    all: {
      sound: {
        ...
        teaser:
          'Оптимальные звуковые концепты, вне зависимости от степени сложности и технических ограничений.',
  ...
  catalog: {
    title: 'Каталог',
    heading: 'Оборудование для аренды или покупки',
    subheading:
      'Мы предлагаем широкий ассортимент оборудования для вашего мероприятия. Цены на покупку и аренду по запросу.',
